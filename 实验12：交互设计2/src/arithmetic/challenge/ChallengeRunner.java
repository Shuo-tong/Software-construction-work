...
public class ChallengeRunner {
    ...
    private void doChallenge() {
        System.out.println("选择难度：[1] L1 入门 [2] L2 进阶 [3] L3 满级");
        System.out.print("请选择：");
        ...
        Challenge ch = new Challenge(userManager.getCurrentUser(), d);
        ch.generate();
        System.out.printf("=== 难度 %s，共 %d 题 ===%n", d.name(), ch.getProblemCount());
